...
(3, '2022_12_10_063243_create_settings_table', 1),
(4, '2022_12_10_063458_create_transaction_details_table', 1),
(5, '2022_12_10_063537_create_transactions_table', 1),
(6, '2022_12_10_063553_create_products_table', 1),
(7, '2022_12_10_063647_create_roles_table', 1),
(8, '2022_12_10_063727_create_categories_table', 1),
(9, '2022_12_10_063746_create_brands_table', 1),
...
CREATE TABLE `settings` (
  ...
  `shop_owner_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `users` (`id`, `role_id`, `name`, `username`, `password`, `phone`) VALUES
(1, 1, 'Kl8JyklsB0', 'user1', '$2y$10$2MchhqYhuGwvTmC09wh4f.cvMMAhIVNvIVeCnK4cOBQoSQ.njfPo2', '0895344455285');
